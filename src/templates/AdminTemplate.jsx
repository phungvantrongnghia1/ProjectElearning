...
import AdminLayout from "../common/components/Admin/AdminLayout/AdminLayout";
import LoginAdmin from "../common/components/Admin/LoginAdmin/LoginAdmin";
const Layout = ({ children, ...res }) => {
  return (
    <div class="wrapper w-100 h-100">
      ...
      <div className="wrapper__body row w-100 h-100 m-0">
        <div className="col-2 left px-0">
              ...
              <div className="sidebar-content">
                <div className="nav-container">
                  <nav
                    ...
                    className="navigation-main text-left"
                  >
        ...
        <div className="col-10 right px-0">{children}</div>
      </div>
    </div>
  );
};
